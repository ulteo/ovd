...
class Preferences_admin {
	...
	public function initialize(){
		$this->titles = array(
			...
			'general_cache_update_interval' => _('Cached logs update interval'),
			'general_cache_expire_time' => _('Cached logs expiry time'),
			...
			'general_slave_server_settings_action_when_as_not_ready' => _('Action when a server status becomes not ready'),
			'general_slave_server_settings_auto_recover' => _('Auto-recover server'),
			'general_slave_server_settings_remove_orphan' => _('Remove orphan applications when an Application Server is deleted'),
			...
			'general_remote_applications_settings' => _('Remote Application Settings'),
			'general_remote_applications_settings_enabled' => _('Enable Remote Applications'),
		
			'general_session_settings_defaults' => _('Session settings'),
			...
			'general_session_settings_defaults_auto_create_profile' => _('Auto-create user profiles when non-existent'),
			...
			'general_session_settings_defaults_advanced_settings_startsession' => _('User selectable parameters'),
