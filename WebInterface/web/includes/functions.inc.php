...
function get_available_languages() {
	return array(array('id' => 'af', 'english_name' => 'Afrikaans'),
		...
		array('id' => 'ar', 'english_name' => 'Arabic', 'local_name' => 'العربية'),
		...
		array('id' => 'da', 'english_name' => 'Danish', 'local_name' => 'Dansk'),
		...
		array('id' => 'fr', 'english_name' => 'French', 'local_name' => 'Français'),
		...
		array('id' => 'ja', 'english_name' => 'Japanese', 'local_name' => '日本語'),
		...
		array('id' => 'no-nb', 'english_name' => 'Norwegian (Bokmal)', 'local_name' => 'Norsk (Bokmål)'),
