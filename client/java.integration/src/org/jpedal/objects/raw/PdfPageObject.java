...
public class PdfPageObject extends PdfObject {
    ...
    public PdfPageObject(String ref) {
        super(ref);
    }

    public PdfPageObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfPageObject(int type) {
    	super(type);
	}
	...
	public boolean getDebugMode() {
		debug=false;//used to toggle so I can debug just this object
		return debug;
	}
