...
//                                idx+" glyphIdArrays="+glyphIdArray[0]+" "+glyphIdArray[1]+" "+glyphIdArray[2]+" offset[i]="+offset[i]);
	...
	public void setEncodingToUse(boolean hasEncoding,int fontEncoding,boolean isSubstituted,boolean isCID) {
        ...
        if(encodingDebug)
        System.out.println("hasEncoding="+hasEncoding+" fontEncoding="+fontEncoding+" isSubstituted="+isSubstituted+" isCID="+isCID);
		...
		if(!isSubstituted && macScore<207){
            ...
            //check for adieresis present in Mac but not windows first
            if(glyphToIndex!=null && macScore>205 && glyphToIndex[138]!=0 && glyphToIndex[228]==0 ){
