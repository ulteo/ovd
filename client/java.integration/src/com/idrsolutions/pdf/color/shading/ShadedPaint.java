...
public class ShadedPaint implements PdfPaint,Paint, Serializable {
	...
	public PaintContext createContext(ColorModel cm,Rectangle db, Rectangle2D ub,
		...
		//@printIssue - creates the paitnContext which converts physical pixels into PDF co-ords and
		...
		if(!isPrinting){
			...
			//System.out.println(printScale);
			//System.out.println("Printing "+xform);
			//System.out.println("page="+pageHeight+" "+scaling+" "+cropH);
			//System.exit(1);
		}
		...
		case LATTICEFORM :
			...
			break;
		case COONS :
			//shading=new CoonsFormPaint(values, currentPdfFile,matrix);
			break;
		case TENSOR :
