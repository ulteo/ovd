...
public class XFAFormObject extends FormObject {
	...
	public void setHorizontalAlign(Object field) {
		...
		if(field.equals("center")){
			...
			alignment = JUSTIFY_EXCEPT_LAST_ALIGNMENT;
		}else if(field.equals("justifyAll")){
			alignment = JUSTIFY_ALIGNMENT;
		}else if(field.equals("left")){
			alignment = JTextField.LEFT;
		}else if(field.equals("radix")){
			alignment = RADIX_ALIGNMENT;
	 ...
	 */
	public void setLocale(String attValue) {
	 ...
	 */
	public void setBindtypeOnMerge(String attValue) {
	 ...
	 */
	public void setPositionToVector(String attValue) {
		//hand - 
	 ...
	 */
	public void setContentType(String attValue) {
		if(XFAFormStream.debugUnimplemented)
