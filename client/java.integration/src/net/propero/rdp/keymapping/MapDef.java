...
public class MapDef {
	...
	private final int FLAG_CAPSLOCK = 0x08; // flag mask for a capslock modifier
	   ...
	   * @param capslockDown
	   */
	  public MapDef(char keyChar, int keyLocation, int scancode, boolean ctrlDown, boolean shiftDown, boolean altDown, boolean capslockDown, Options opt_) {
	  	this.opt = opt_;
	   ...
	   * @param capslockDown
	   */
	  public MapDef(int keyCode, int keyLocation, int scancode, boolean ctrlDown, boolean shiftDown, boolean altDown, boolean capslockDown, Options opt_) {
	  	this.opt = opt_;
	  ...
	  protected boolean appliesToTyped(KeyEvent e, boolean capslock){
	  	...
	  	if(Constants.OS == Constants.MAC){
	  		...
	  		if(this.opt.remap_hash && (e.getKeyChar() == '�')){
