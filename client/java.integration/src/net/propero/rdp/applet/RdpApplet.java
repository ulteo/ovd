...
public class RdpApplet extends Applet {
  ...
  public static RdpApplet refApplet;
  ...
  public void openUrl(String url) {
   ...
   public void paint(Graphics g){
       ...
       int width = g.getFontMetrics().stringWidth("Launching UlteoRDP session...");
       int x = (int) (g.getClipBounds().getWidth() / 2) - (width/2);
       int y = (int) (g.getClipBounds().getHeight() / 2);
       if(!redirectOutput) g.drawString("Launching UlteoRDP session...", x, y);
   ...
   RdpThread rThread = null;
    ...
    public void start(){    
        ...
        Rdesktop.common.underApplet = true;
        ...
        argLine += " " +  genParam("-A","seamless");
        argLine += " " +  genParam("-D","disk");
...
class RdpThread extends Thread{
    ...
    public void run(){
        ...
        Rdesktop.common.underApplet = false;
    }
}
