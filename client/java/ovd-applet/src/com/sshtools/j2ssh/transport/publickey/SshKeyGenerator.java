...
public class SshKeyGenerator {
  ...
  private static final boolean guiAvailable = false;
...
//  }
  ...
  public void generateKeyPair(String type, int bits, String filename,
                              String username, String passphrase) throws
      IOException {
...
//  }
   ...
   * @throws IOException
   */
  public static String convertPublicKeyFile(File f, SshPublicKeyFormat convert) throws
