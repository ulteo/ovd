...
protected void onStop() {
   ...
   * @throws IOException
   */
  public  final synchronized void sendChannelData(Channel channel, byte[] data) throws IOException {
    synchronized (channel.getState()) {
      ...
      while (sent < data.length) 
		...
		max = ((window.getWindowSpace() < channel.getRemotePacketSize()) && (window.getWindowSpace() > 0)) ? 
