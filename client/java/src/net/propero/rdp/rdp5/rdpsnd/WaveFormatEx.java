...
public class WaveFormatEx {
	...
	public String toString() {
		...
		out.append( "[wFormatTag: " ).append( wFormatTag ).append( ", nChannels: " ).append( nChannels ).append( ", nSamplesPerSec: " );
		out.append( nSamplesPerSec ).append( ", nAvgBytesPerSec: " ).append( nAvgBytesPerSec ).append( ", nBlockAlign: " );
		out.append( nBlockAlign ).append( ", wBitsPerSample: " ).append( wBitsPerSample ).append( ", cbSize: " ).append( cbSize );
		out.append( "]" );
		return out.toString();
	}
