...
public class PdfColorSpaceObject extends PdfObject {
	...
	PdfObject alternateSpace, IndexedColorSpace, tintTransform;
    ...
    public PdfColorSpaceObject(String ref) {
        super(ref);
    }

    public PdfColorSpaceObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfColorSpaceObject(int type) {
    	super(type);
	}
    
    public PdfColorSpaceObject(byte[] bytes) {
