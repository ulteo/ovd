...
public class PdfExtGStateObject extends PdfObject {
    ...
    public PdfExtGStateObject(String ref) {
        super(ref);
    }

    public PdfExtGStateObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfExtGStateObject(int type) {
    	super(type);
	}
