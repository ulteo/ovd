...
public class PdfResourcesObject extends PdfObject {
	...
	private PdfObject ExtGState,Font, Pattern,XObject=null;
	
    public PdfResourcesObject(String ref) {
        super(ref);
    }

    public PdfResourcesObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfResourcesObject(int type) {  	
    	super(type);
	}
