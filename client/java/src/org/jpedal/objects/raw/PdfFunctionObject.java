...
public class PdfFunctionObject extends PdfObject {
    ...
    public PdfFunctionObject(String ref) {
        super(ref);
    }

    public PdfFunctionObject(int ref, int gen) {
       super(ref,gen);
    }
    ...
    public PdfFunctionObject(int type) {
    	super(type);
	}
