...
public class SwingFormButtonListener implements MouseListener {
     ...
     */
    public SwingFormButtonListener(String ref, String inCommand, AcroRenderer acrorenderer) {
    	if(showMethods)
    		System.out.println("SwingFormButtonListener.SwingFormButtonListener(string string acrorenderer)");
    	
        this.ref = ref;
        command = inCommand;
        acrorend = acrorenderer;

        //javascript = acrorend.getJavaScriptObject();
    }
     ...
     */
    public SwingFormButtonListener(Map dataMap, AcroRenderer acrorenderer) {
    	if(showMethods)
    		System.out.println("SwingFormButtonListener.SwingFormButtonListener(map acrorenderer)");
    }
...
//		case XFAFormObject.ACTION_MOUSERELEASE:
    ...
    public void mouseEntered(MouseEvent e) {
        if (debugMouseActions || showMethods)
        ...
        System.out.println("formButton entered command="+enteredAction);
        ...
        //<start-os>
        if (javascriptWhen == XFAFormObject.ACTION_MOUSEENTER) {
            javascript.execute(ref, ActionHandler.MOUSEENTERED, ActionHandler.FOCUS_EVENT,' ');
        }
        //<end-os>
    }
    ...
    public void mouseExited(MouseEvent e) {
        ...
        System.out.println("fomrbutton exited command="+exitedAction);
        ...
        //<start-os>
        if (javascriptWhen == XFAFormObject.ACTION_MOUSEEXIT) {
            javascript.execute(ref, ActionHandler.MOUSEEXITED, ActionHandler.FOCUS_EVENT,' ');
        }
        //<end-os>
    }
...
//			((JComboBox) e.getSource()).showPopup();
        ...
        //<start-os>
        if (javascriptWhen == XFAFormObject.ACTION_MOUSEPRESS) {
            javascript.execute(ref, ActionHandler.MOUSEPRESSED, ActionHandler.FOCUS_EVENT,' ');
        }
        //<end-os>
    }
...
//			ignore as is delt with in mousePressed()
        ...
        //<start-os>
        if (javascriptWhen == XFAFormObject.ACTION_MOUSERELEASE) {
            javascript.execute(ref, ActionHandler.MOUSERELEASED, ActionHandler.FOCUS_EVENT,' ');
        }
        //<end-os>
    }
}
