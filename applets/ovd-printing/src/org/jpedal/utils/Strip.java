...
public class Strip
{
	 ...
	 * strip the []
	 */
	final public static String removeArrayDeleminators( String value )
	{
		char c = ' ';
	...
	final public static StringBuffer trim( StringBuffer content_buffer )
	{
		...
		*/
		...
		/**
		while((len2>0)&&(cb.charAt(0)==' ')){
			len2--;
			cb.deleteCharAt(0);
		}
		if(!cb.toString().equals(content_buffer.toString())){
			System.out.println("cb="+cb);
			System.out.println("oringinal-"+content_buffer);
			System.exit(1);
		}*/
