...
public interface FormFactory {
    ...
    public static final String[] typesAsString={"UNKNOWN","LIST","COMBOBOX", "SINGLELINETEXT",
    	"SINGLELINEPASSWORD","MULTILINETEXT","MULTILINEPASSWORD","PUSHBUTTON",
    	"RADIOBUTTON","CHECKBOXBUTTON","ANNOTATION","SIGNATURE"};
