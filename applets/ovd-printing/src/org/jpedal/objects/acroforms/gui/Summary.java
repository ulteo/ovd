...
public class Summary extends javax.swing.JPanel {
     ...
     * @param sig
     */
    public Summary(JDialog frame, Map sig) {
        this.frame = frame;
        this.sigObject = sig;
        initComponents();
    }
    ...
    private void showCertificate(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showCertificate
        ...
        try {
            byte[] bytes = (byte[]) sigObject.get("Cert");
...
//			System.out.println(signingCertificate.getPublicKey().getFormat());
            ...
            ch.setValues((String) sigObject.get("Name"), signingCertificate.getVersion(), signingCertificate.getSigAlgName(),
     ...
     */
    private byte[] getDigest(byte[] bytes, String algorithm) throws NoSuchAlgorithmException {
