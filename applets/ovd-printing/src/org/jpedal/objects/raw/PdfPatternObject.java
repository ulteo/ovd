...
public class PdfPatternObject extends PdfXObject {
    ...
    public PdfPatternObject(String ref) {
        super(ref);
    }

    public PdfPatternObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfPatternObject(int type) {  	
    	super(type);
	}
