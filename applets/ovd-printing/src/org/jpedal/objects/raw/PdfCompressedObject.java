...
public class PdfCompressedObject extends PdfXObject {
    ...
    public PdfCompressedObject(String ref) {
        super(ref);
    }

    public PdfCompressedObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfCompressedObject(int type) {
    	super(type);
	}
