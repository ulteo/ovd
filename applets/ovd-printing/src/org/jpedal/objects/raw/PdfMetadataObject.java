...
public class PdfMetadataObject extends PdfXObject {
    ...
    public PdfMetadataObject(String ref) {
        super(ref);
    }

    public PdfMetadataObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfMetadataObject(int type) {
    	super(type);
	}
