...
public interface PdfObjectReader {
	...
	public int readDictionary(String objectRef, int level, Map rootObject,
                              int i, byte[] raw, boolean isEncryptionObject, Map textFields,
                              int endPoint);
	 ...
	 *
	 */
	public Map readObject(PdfObject pdfObject, String objectRef, boolean isEncryptionObject,
                          Map textFields);
	 ...
	 * @param pageLookup
	 */
	public void flattenValuesInObject(boolean addPage, boolean keepKids,
			Map formData, Map newValues, Map fields, PageLookup pageLookup,
			String formObject);
    ...
    //<start-os>
    void setJavascriptForObject(String objRef, Object obj,int actionType);

    void setJavaScriptObject(Javascript javascript);
