...
public class Values {
	...
	/**
	 * flag to show if extraction from screen text or images
	 */
	public boolean isExtractImageOnSelection() {
		return extractImageOnSelection;
	}
	
	/**
	 * toggle if extraction from screen text or images - only works in
	 * Ent
	 */
	public void toggleExtractImageOnSelection() {
		extractImageOnSelection=!extractImageOnSelection;
	}
