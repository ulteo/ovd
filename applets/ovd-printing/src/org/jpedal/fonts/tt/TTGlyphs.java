...
/*
	...
	public int getConvertedGlyph(int idx){
		...
		if(currentCMAP==null)
			...
			return currentCMAP.convertIndexToCharacterCode(null,idx,false,false);
     ...
     */
    public String[] readFontNames(FontData fontData,int mode) {
     ...
     */
    public void addStringValues(FontData fontData, Map fontDetails) {
