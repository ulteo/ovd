...
public class PdfShadingObject extends PdfObject {
    ...
    public PdfShadingObject(String ref) {
        super(ref);
    }

    public PdfShadingObject(int ref, int gen) {
       super(ref,gen);
    }


    public PdfShadingObject(int type) {  	
    	super(type);
	}
