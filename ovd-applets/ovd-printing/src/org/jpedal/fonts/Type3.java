...
public class Type3 extends PdfFont {
     ...
     * @param currentGraphicsState - pass in copy
    ...
    private void readEmbeddedFont(PdfObject pdfObject, ObjectStore objectStore) {
        ...
        if(CharProcs!=null){
            ...
            while(keyPairs.hasMorePairs()){
                ...
                if(diffLookup!=null){
                	String pKey= StandardFonts.convertNumberToGlyph(glyphKey);
                ...
                if(glyphObj!=null && renderPage){
                    ...
                    try{
                        ...
                        T3Size t3 = glyphDecoder.decodePageContent(glyphObj,0,0, null, null);


                        renderX=t3.x;
                        renderY=t3.y;
                    
                    	glyphs.setT3Glyph(key,new T3Glyph(glyphDisplay, renderX,renderY,glyphDecoder.ignoreColors,glyphKey));
                    }catch(Exception e){
                    	e.printStackTrace();
