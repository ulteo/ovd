...
public final class SshMessageStore {
  ...
  public synchronized SshMessage getMessage(int[] messageIdFilter, int timeout) throws
    ...
    System.err.println("Cause #3.\n MsgStore.isClosed: "+isClosed+"\n");
