...
class AuthMethod_Token extends AuthMethod {
	...
	public static function configuration() {
		return array(
			new ConfigElement_input('url', 'http://trust.server.com?token=%TOKEN%'),
			new ConfigElement_input('user_node_name', 'user'),
			new ConfigElement_input('login_attribute_name', 'login')
		);
	}
