...
class Preferences {
	...
	public function initialize(){
		...
		$c->setContentAvailable(array('auto'=>_('Autodetect'),'ar_AE'=>'العربي','de_DE'=>'Deutsch','en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','id_ID'=>'Bahasa Indonesia','it_IT'=>'Italiano','ja_JP'=>'日本語','nl_NL'=>'Nederlands','pt_BR'=>'Português (Brasil)','ru_RU'=>'Русский','zh_CN'=>'中文简体'));
		$this->add($c,'general');
...
// 		$this->add('general',$c);
		...
		$c->setContentAvailable(array('desktop'=>_('Desktop'), 'portal'=>_('Portal'), 'external'=>_('External')));
		...
		$c->setContentAvailable(array('ar_AE'=>'العربي','de_DE'=>'Deutsch','en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','id_ID'=>'Bahasa Indonesia','it_IT'=>'Italiano','ja_JP'=>'日本語','nl_NL'=>'Nederlands','pt_BR'=>'Português (Brasil)','ru_RU'=>'Русский','zh_CN'=>'中文简体'));
		$this->add($c,'general','session_settings_defaults');
