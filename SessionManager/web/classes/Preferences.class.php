...
class Preferences {
	...
	public function initialize(){
		...
		$c->setContentAvailable(array('auto'=>_('Autodetect'),'en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','ja_JP'=>'日本語','ru_RU'=>'Русский'));
		$this->add($c,'general');
...
// 		$this->add('general',$c);
		...
		$c->setContentAvailable(array('en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','ja_JP'=>'日本語','ru_RU'=>'Русский'));
		$this->add($c,'general','session_settings_defaults');
