...
class Preferences {
	...
	public function initialize(){
		...
		$c->setContentAvailable(array('auto'=>_('Autodetect'),'de_DE'=>'Deutsch','en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','it_IT'=>'Italiano','ja_JP'=>'日本語','nl_NL'=>'Nederlands','pt_BR'=>'Português (Brasil)','ru_RU'=>'Русский'));
		$this->add($c,'general');
...
// 		$this->add('general',$c);
		...
		$c->setContentAvailable(array('de_DE'=>'Deutsch','en_GB'=>'English','es_ES'=>'Español','fr_FR'=>'Français','it_IT'=>'Italiano','ja_JP'=>'日本語','nl_NL'=>'Nederlands','pt_BR'=>'Português (Brasil)','ru_RU'=>'Русский'));
		$this->add($c,'general','session_settings_defaults');
