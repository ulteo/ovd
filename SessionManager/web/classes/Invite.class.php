...
// 		Logger::debug('main', 'Starting Invite::hasAttribute for \''.$this->id.'\' attribute '.$attrib_);
...
// 		Logger::debug('main', 'Starting Invite::getAttribute for \''.$this->id.'\' attribute '.$attrib_);
...
// 		Logger::debug('main', 'Starting Invite::setAttribute for \''.$this->id.'\' attribute '.$attrib_.' value '.$value_);
