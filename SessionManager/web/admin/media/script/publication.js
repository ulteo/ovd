...
function ovdsm_publication_hook_select(select_src) {
	...
	var input = document.getElementById("input_"+select_src.name)
	var select_dst = document.getElementById("select_" + rows[(ind_row+1)%2])
	...
	var list_table = document.getElementById("publications_list_table")
