...
;; ULTEO CODE - BEGIN
  !macro FUNC_WAITSERVICESTATUS UN
    Push $0
    Push $1
    Push $2
    Exch 3
...
;   Push "name"
;   Push "state"
;   Call WaitServiceState
;   Pop $0 ;service state
  Function WaitServiceStatus
    !insertmacro FUNC_WAITSERVICESTATUS ""
  FunctionEnd
  
  Function un.WaitServiceStatus
    !insertmacro FUNC_WAITSERVICESTATUS "un."
  FunctionEnd
;; ULTEO CODE - END
